...
# 💡 마법의 경로 추가 코드: 현재 폴더와 부모 폴더를 모두 파이썬 길찾기에 추가!
...
# 💡 1. 선배님의 원본 임포트 그대로 사용! (경고 문구는 무시하셔도 전혀 문제없습니다)
...
def run_evaluation():
    ...
    score = evaluate(
        dataset,
        metrics=[
            faithfulness,       # 선배님 코드 그대로!
            answer_relevancy,   # 선배님 코드 그대로!
            context_precision,  # 선배님 코드 그대로!
            context_recall,     # 선배님 코드 그대로!
        ],
